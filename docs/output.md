...
* [DE_matrix.txt](../ANALYSIS/10-DESeq2/DE_matrix.txt)
  * Comparative table with the differential expression of two conditions.
* [clinical_data.txt](../ANALYSIS/10-DESeq2/clinical_data.txt)
  * Table with the metadata used to compare the samples.
* [maPlot.pdf](../ANALYSIS/10-DESeq2/maPlot.pdf)
  * MA plot of the DESeq analysis results for all the samples
* [heatmap_sample_to_sample.pdf](../ANALYSIS/10-DESeq2/heatmap_sample_to_sample.pdf)
  * Heatmap with the euclidean distance between samples.
* [plotPCA.pdf](../ANALYSIS/10-DESeq2/plotPCA.pdf)
...
* [boxplot.pdf](../ANALYSIS/10-DESeq2/boxplot.pdf)
...
* [plotDispersions.pdf](../ANALYSIS/10-DESeq2/plotDispersions.pdf)
...
* [hierarchical_clustering.pdf](../ANALYSIS/10-DESeq2/hierarchical_clustering.pdf)
...
* [heatmapCount_top20.pdf](../ANALYSIS/10-DESeq2/heatmapCount_top20.pdf)
...
* [heatmapCount_all_genes.pdf](../ANALYSIS/10-DESeq2/heatmapCount_all_genes.pdf)
  * Heatmap of the normalized counts of all the genes.
* [plotSD.pdf](../ANALYSIS/10-DESeq2/plotSD.pdf)
